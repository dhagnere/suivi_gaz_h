...
User.prototype.validate = function () {
  ...
  if (this.data.username !="" && !validator.isAlphanumeric(this.data.username)){this.errors.push("Le nom d'utiisateur doit être composé uniquement de caractères alphanumériques.")}
